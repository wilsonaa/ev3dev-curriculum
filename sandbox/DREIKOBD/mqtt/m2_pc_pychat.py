...
Authors: David Fisher and Benjamin Driekosen and Aaron Wilson.
...
def main():
    ...
    my_name = "Ben"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Aaron"  # Used to set the topic that you will *publish to*
