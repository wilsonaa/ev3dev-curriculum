...
Much like we did in WILSONAA of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    while True:
        ...
        #      -- prin`st to provide you with code examples for using the LEDs.  It does not need to run anymore.
